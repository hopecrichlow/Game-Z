...
// Good Guy Instance
var goku = new _goodguy2['default']();
// Bad Guy Instance
var cell = new _badguy2['default']();

// Select DOM Nodes
var gHealth = (0, _jquery2['default'])('.gHealth');
var cHealth = (0, _jquery2['default'])('.cHealth');
var attack = (0, _jquery2['default'])('.attack');
...
attack.on('click', function () {
  ...
  if (cell.health <= 0) {
    ...
    (0, _jquery2['default'])(".errorMessages").text("Cell is weak... Goku wins!!!").fadeIn();
